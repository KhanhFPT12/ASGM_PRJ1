...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container">
            <!-- Logo và chữ 6Gym -->
            <a class="navbar-brand" href="courseHome">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarsExampleDefault">
                <ul class="navbar-nav">
                    <li class="nav-item active"><a class="nav-link" href="courseHome">Trang chủ</a></li>
    ...
    <section class="jumbotron text-center" style="background-image: url('${pageContext.request.contextPath}/images/khoahoc.jpg'); background-size: cover; background-position: center; position: relative; color: #fff; padding: 100px 20px;">
        <div class="container" style="position: relative; z-index: 1; background-color: rgba(0, 0, 0, 0.5); padding: 20px; border-radius: 10px;">
            ...
            <p>
                ...
                <a href="#popular-courses" class="btn btn-outline-light btn-lg my-2" style="border-color: #fff; color: #fff;">Tìm hiểu thêm</a>
            </p>
        </div>
    </section>
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <c:choose>
                                                ...
                                                <c:when test="${course.courseId == 9}">
                                                    <a href="detail_course/calis.jsp">${course.courseName}</a>
                                                </c:when>
                                                <c:when test="${course.courseId == 10}">
                                                    <a href="detail_course/Cross.jsp">${course.courseName}</a>
                                                </c:when>
                                                <c:otherwise>
                                        ...
                                        <a href="login.jsp" class="btn btn-warning btn-block">Đăng nhập để đăng ký</a>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul>
                        <li><a href="courseHome"><i class="fa fa-home"></i> Trang chủ</a></li>
    ...
    <script>
        ...
        // Kiểm tra và tải lại chatbot nếu cần
        window.addEventListener('load', function () {
            if (typeof window.DFMessenger !== 'undefined') {
                console.log("Dialogflow Messenger đã được tải.");
            } else {
                console.error("Không thể tải Dialogflow Messenger. Kiểm tra kết nối hoặc cấu hình.");
            }
        });
    </script>
