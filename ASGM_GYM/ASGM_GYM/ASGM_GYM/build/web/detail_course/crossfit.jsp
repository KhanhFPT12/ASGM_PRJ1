...
<head>
    ...
    <title>Chi tiết Khóa Học: CrossFit - 6Gym</title>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="course-header">
                        <h2 class="course-title">CrossFit</h2>
                    </div>

                    <div class="course-image">
                        <img src="${pageContext.request.contextPath}/images/Cross.jpg" alt="CrossFit" class="img-fluid">
                    </div>

                    <p class="course-description">
                        Thử thách giới hạn của bạn với khóa học CrossFit! Kết hợp cử tạ, thể dục dụng cụ và cardio, CrossFit là chương trình tập luyện cường độ cao giúp bạn cải thiện toàn diện sức mạnh, sức bền, sự dẻo dai và tốc độ. Sẵn sàng để vượt qua chính mình?
                    </p>

                    <h4 class="features-title">Đặc điểm nổi bật:</h4>
                    <ul class="features-list">
                        <li><i class="fas fa-check-circle"></i> Phát triển toàn diện các tố chất thể lực.</li>
                        <li><i class="fas fa-check-circle"></i> Các bài tập đa dạng, không gây nhàm chán.</li>
                        <li><i class="fas fa-check-circle"></i> Môi trường tập luyện cộng đồng, tạo động lực cao.</li>
                        <li><i class="fas fa-check-circle"></i> Huấn luyện viên chuyên nghiệp, giàu kinh nghiệm.</li>
                        <li><i class="fas fa-check-circle"></i> Thích hợp cho người có kinh nghiệm tập luyện và muốn thử thách bản thân.</li>
                    </ul>
                </div>
                    ...
                    <div class="course-info-card card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-info">
                                <p><i class="far fa-calendar-alt"></i> <strong>Thời gian:</strong> 12 tuần</p>
                                <p><i class="fas fa-users"></i> <strong>Đối tượng:</strong> Người có kinh nghiệm tập luyện, muốn thử thách bản thân</p>
                                <p><i class="fas fa-user-tie"></i> <strong>Huấn luyện viên:</strong> Trần Thị D</p>
                                <p><i class="fas fa-fire"></i> <strong>Cường độ:</strong> Cao</p>
                            </div>
