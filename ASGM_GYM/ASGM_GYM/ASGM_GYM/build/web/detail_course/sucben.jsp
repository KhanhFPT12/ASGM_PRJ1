...
<head>
    ...
    <title>Chi tiết Khóa Học: Tập Luyện Sức Bền - 6Gym</title>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="course-header">
                        <h2 class="course-title">Tập Luyện Sức Bền</h2>
                    </div>

                    <div class="course-image">
                        <img src="${pageContext.request.contextPath}/images/sucben.jpg" alt="Tập Luyện Sức Bền" class="img-fluid">
                    </div>

                    <p class="course-description">
                        Khóa học "Tập Luyện Sức Bền" được thiết kế để giúp bạn tăng cường sức bền và khả năng chịu đựng của cơ thể thông qua các bài tập cardio và sức mạnh. Dưới sự hướng dẫn của các huấn luyện viên chuyên nghiệp, bạn sẽ được cung cấp một chương trình tập luyện và chế độ dinh dưỡng phù hợp để đạt được mục tiêu của mình.
                    </p>

                    <h4 class="features-title">Đặc điểm nổi bật:</h4>
                    <ul class="features-list">
                        <li><i class="fas fa-check-circle"></i> Các bài tập cardio và sức mạnh kết hợp.</li>
                        <li><i class="fas fa-check-circle"></i> Chế độ dinh dưỡng hỗ trợ tăng sức bền.</li>
                ...
                <div class="col-lg-4">
                    <div class="course-info-card card">
                        ...
                        <div class="card-body">
                            <div class="course-price">1,300,000 ₫</div>
                            <div class="course-info">
                                <p><i class="far fa-calendar-alt"></i> <strong>Thời gian:</strong> 12 tuần</p>
                                <p><i class="fas fa-users"></i> <strong>Đối tượng:</strong> Người muốn tăng sức bền và sức chịu đựng</p>
                                <p><i class="fas fa-user-tie"></i> <strong>Huấn luyện viên:</strong> Chuyên gia thể lực</p>
                                <p><i class="fas fa-running"></i> <strong>Cường độ:</strong> Trung bình</p>
                            </div>
                            <form action="${pageContext.request.contextPath}/cart" method="post">
                                ...
                                <button type="submit" class="btn btn-warning btn-register btn-block">
                                    <i class="fas fa-battery-full mr-2"></i> Đăng ký ngay
                                </button>
                            </form>
                        </div>
                    </div>
