...
<head>
    ...
    <title>Chi tiết Khóa Học: KickFit - 6Gym</title>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="course-header">
                        <h2 class="course-title">KickFit</h2>
                    </div>

                    <div class="course-image">
                        <img src="${pageContext.request.contextPath}/images/kick.jpg" alt="KickFit" class="img-fluid">
                    </div>

                    <p class="course-description">
                        Giải phóng năng lượng, đốt cháy calo và rèn luyện sức mạnh toàn thân với khóa học KickFit! Kết hợp các động tác đấm, đá từ boxing và Muay Thái, KickFit mang đến trải nghiệm tập luyện cardio cường độ cao, giúp bạn giảm cân hiệu quả và tăng cường khả năng tự vệ.
                    </p>

                    <h4 class="features-title">Đặc điểm nổi bật:</h4>
                    <ul class="features-list">
                        <li><i class="fas fa-check-circle"></i> Đốt cháy calo cực nhanh, giảm cân hiệu quả.</li>
                        <li><i class="fas fa-check-circle"></i> Rèn luyện sức mạnh, sự nhanh nhẹn và phản xạ.</li>
                        <li><i class="fas fa-check-circle"></i> Giải tỏa căng thẳng, tăng cường sự tự tin.</li>
                        <li><i class="fas fa-check-circle"></i> Học các kỹ năng tự vệ cơ bản.</li>
                        <li><i class="fas fa-check-circle"></i> Phù hợp cho mọi giới tính và trình độ thể lực.</li>
                    </ul>
                </div>
                    ...
                    <div class="course-info-card card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-info">
                                <p><i class="far fa-calendar-alt"></i> <strong>Thời gian:</strong> 8 tuần</p>
                                <p><i class="fas fa-users"></i> <strong>Đối tượng:</strong> Mọi đối tượng, ưu tiên người muốn giảm cân và tăng cường thể lực</p>
                                <p><i class="fas fa-user-tie"></i> <strong>Huấn luyện viên:</strong> Lê Văn C</p>
                                <p><i class="fas fa-stopwatch"></i> <strong>Thời lượng:</strong> 60 phút/buổi, 3 buổi/tuần</p>
                            </div>
                            <form action="${pageContext.request.contextPath}/cart" method="post">
                                <input type="hidden" name="action" value="add">
                                <input type="hidden" name="courseId" value="8">
