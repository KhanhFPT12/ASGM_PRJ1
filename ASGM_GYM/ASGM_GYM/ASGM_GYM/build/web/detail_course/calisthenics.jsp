...
<head>
    ...
    <title>Chi tiết Khóa Học: Calisthenics - 6Gym</title>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="course-header">
                        <h2 class="course-title">Calisthenics</h2>
                    </div>

                    <div class="course-image">
                        <img src="${pageContext.request.contextPath}/images/Calis.jpg" alt="Calisthenics" class="img-fluid">
                    </div>

                    <p class="course-description">
                        Khóa học "Calisthenics" là một hệ thống bài tập sử dụng trọng lượng cơ thể làm kháng lực chính. Nó tập trung vào phát triển sức mạnh chức năng, sự linh hoạt, và khả năng kiểm soát cơ thể.  Không cần tạ, chỉ cần bạn và sự kiên trì!
                    </p>

                    <h4 class="features-title">Đặc điểm nổi bật:</h4>
                    <ul class="features-list">
                        <li><i class="fas fa-check-circle"></i> Tập luyện mọi lúc mọi nơi, không cần thiết bị.</li>
                        <li><i class="fas fa-check-circle"></i> Phát triển sức mạnh toàn diện và kiểm soát cơ thể.</li>
                        <li><i class="fas fa-check-circle"></i> Cải thiện sự linh hoạt và thăng bằng.</li>
                        <li><i class="fas fa-check-circle"></i> Giảm nguy cơ chấn thương so với tập tạ truyền thống.</li>
                        <li><i class="fas fa-check-circle"></i> Phù hợp với mọi trình độ, từ người mới bắt đầu đến vận động viên chuyên nghiệp.</li>
                    </ul>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="course-info-card card">
                        ...
                        <div class="card-body">
                            <div class="course-price">1,400,000 ₫</div>
                            <div class="course-info">
                                <p><i class="far fa-calendar-alt"></i> <strong>Thời gian:</strong> 10 tuần</p>
                                <p><i class="fas fa-users"></i> <strong>Đối tượng:</strong> Mọi đối tượng, thích hợp cho người mới bắt đầu</p>
                                <p><i class="fas fa-user-tie"></i> <strong>Huấn luyện viên:</strong> Nguyễn Thị B</p>
                                <p><i class="fas fa-running"></i> <strong>Cường độ:</strong> Từ nhẹ đến trung bình, có thể điều chỉnh theo khả năng</p>
                            </div>
