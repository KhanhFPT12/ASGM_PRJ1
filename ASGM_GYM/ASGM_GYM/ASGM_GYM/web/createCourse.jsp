...
<head>
    ...
    <title>Thêm khóa học mới - 6Gym</title>
...
<body>
    <div class="container">
        <div class="create-course-card card">
            <div class="card-header">
                <h5 class="card-title">Thêm khóa học mới</h5>
            </div>
            <div class="card-body">
                <form action="<%= request.getContextPath() %>/courseList" method="post" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fas fa-plus-circle mr-2"></i>Thêm khóa học</button>
                </form>
