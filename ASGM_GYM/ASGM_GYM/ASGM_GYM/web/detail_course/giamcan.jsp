...
<head>
    ...
    <title>Chi tiết Khóa Học: Giảm Cân Hiệu Quả - 6Gym</title>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="course-header">
                        <h2 class="course-title">Giảm Cân Hiệu Quả</h2>
                    </div>

                    <div class="course-image">
                        <img src="${pageContext.request.contextPath}/images/giamcan.jpg" alt="Giảm Cân Hiệu Quả" class="img-fluid">
                    </div>

                    <p class="course-description">
                        Khóa học "Giảm Cân Hiệu Quả" được thiết kế dành riêng cho những ai muốn giảm cân một cách khoa học và bền vững. Với sự hướng dẫn của các huấn luyện viên chuyên nghiệp, bạn sẽ được cung cấp một lộ trình tập luyện và chế độ dinh dưỡng phù hợp để đạt được mục tiêu giảm cân nhanh chóng và an toàn.
                    </p>

                    <h4 class="features-title">Đặc điểm nổi bật:</h4>
                    <ul class="features-list">
                        <li><i class="fas fa-check-circle"></i> Giáo trình cá nhân hóa theo từng học viên.</li>
                        <li><i class="fas fa-check-circle"></i> Kết hợp tập luyện cardio và bài tập sức mạnh.</li>
                        <li><i class="fas fa-check-circle"></i> Hướng dẫn chế độ ăn uống khoa học.</li>
                        <li><i class="fas fa-check-circle"></i> Hỗ trợ 1:1 từ huấn luyện viên.</li>
                        <li><i class="fas fa-check-circle"></i> Thời gian linh hoạt, phù hợp với lịch trình bận rộn.</li>
                    </ul>
                </div>
                    ...
                    <div class="course-info-card card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-info">
                                ...
                                <p><i class="fas fa-users"></i> <strong>Đối tượng:</strong> Người mới bắt đầu, người muốn giảm cân</p>
                                <p><i class="fas fa-user-tie"></i> <strong>Huấn luyện viên:</strong> Chuyên gia dinh dưỡng & thể hình</p>
                            </div>
                            <form action="${pageContext.request.contextPath}/cart" method="post">
                                ...
                                <button type="submit" class="btn btn-warning btn-register btn-block">
                                    <i class="fas fa-weight mr-2"></i> Đăng ký ngay
                                </button>
                            </form>
                        </div>
                    </div>
