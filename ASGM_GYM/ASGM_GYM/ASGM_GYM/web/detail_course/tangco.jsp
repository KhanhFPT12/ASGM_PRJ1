...
<head>
    ...
    <title>Chi tiết Khóa Học: Tăng Cơ Bắp Nhanh Chóng - 6Gym</title>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="course-header">
                        <h2 class="course-title">Tăng Cơ Bắp Nhanh Chóng</h2>
                    </div>

                    <div class="course-image">
                        <img src="${pageContext.request.contextPath}/images/tangcobap.jpg" alt="Tăng Cơ Bắp Nhanh Chóng" class="img-fluid">
                    </div>

                    <p class="course-description">
                        Khóa học "Tăng Cơ Bắp Nhanh Chóng" được thiết kế để giúp bạn xây dựng cơ bắp một cách hiệu quả và nhanh chóng. Dưới sự hướng dẫn của các huấn luyện viên chuyên nghiệp, bạn sẽ được cung cấp một chương trình tập luyện và chế độ dinh dưỡng phù hợp để đạt được mục tiêu tăng cơ của mình.
                    </p>

                    <h4 class="features-title">Đặc điểm nổi bật:</h4>
                    <ul class="features-list">
                        <li><i class="fas fa-check-circle"></i> Giáo trình tập luyện chuyên sâu.</li>
                        <li><i class="fas fa-check-circle"></i> Chế độ dinh dưỡng tối ưu cho tăng cơ.</li>
                        ...
                        <li><i class="fas fa-check-circle"></i> Thời gian linh hoạt.</li>
                    </ul>
                </div>
                    ...
                    <div class="course-info-card card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-info">
                                ...
                                <p><i class="fas fa-users"></i> <strong>Đối tượng:</strong> Người có kinh nghiệm tập luyện</p>
                                <p><i class="fas fa-user-tie"></i> <strong>Huấn luyện viên:</strong> Chuyên gia thể hình</p>
                                <p><i class="fas fa-clock"></i> <strong>Thời lượng:</strong> 4 buổi/tuần</p>
                            </div>
