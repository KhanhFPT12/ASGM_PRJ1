...
<head>
    ...
    <title>Chi tiết Khóa Học: Cardio và Đốt Mỡ - 6Gym</title>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="course-header">
                        <h2 class="course-title">Cardio và Đốt Mỡ</h2>
                    </div>

                    <div class="course-image">
                        <img src="${pageContext.request.contextPath}/images/cardio.jpg" alt="Cardio và Đốt Mỡ" class="img-fluid">
                    </div>

                    <p class="course-description">
                        Khóa học "Cardio và Đốt Mỡ" được thiết kế để giúp bạn giảm cân và cải thiện sức khỏe tim mạch thông qua các bài tập cardio hiệu quả. Dưới sự hướng dẫn của các huấn luyện viên chuyên nghiệp, bạn sẽ được cung cấp một chương trình tập luyện và chế độ dinh dưỡng phù hợp để đạt được mục tiêu giảm cân của mình.
                    </p>

                    <h4 class="features-title">Đặc điểm nổi bật:</h4>
                    <ul class="features-list">
                        <li><i class="fas fa-check-circle"></i> Các bài tập cardio đa dạng và hiệu quả.</li>
                        <li><i class="fas fa-check-circle"></i> Chế độ dinh dưỡng hỗ trợ đốt mỡ.</li>
                    ...
                    <div class="course-info-card card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-info">
                                ...
                                <p><i class="fas fa-users"></i> <strong>Đối tượng:</strong> Người muốn giảm cân và cải thiện tim mạch</p>
                                <p><i class="fas fa-user-tie"></i> <strong>Huấn luyện viên:</strong> Chuyên gia thể hình</p>
                                <p><i class="fas fa-heartbeat"></i> <strong>Cường độ:</strong> Từ trung bình đến cao</p>
                            </div>
                            <form action="${pageContext.request.contextPath}/cart" method="post">
                                ...
                                <button type="submit" class="btn btn-warning btn-register btn-block">
                                    <i class="fas fa-fire mr-2"></i> Đăng ký ngay
                                </button>
                            </form>
                        </div>
                    </div>
