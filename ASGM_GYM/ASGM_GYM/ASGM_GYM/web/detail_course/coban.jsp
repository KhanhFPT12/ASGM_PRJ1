...
<head>
    ...
    <title>Chi tiết Khóa Học: Tập Gym Cơ Bản - 6Gym</title>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="course-header">
                        <h2 class="course-title">Tập Gym Cơ Bản</h2>
                    </div>
                    
                    <div class="course-image">
                        <img src="${pageContext.request.contextPath}/images/moitap.jpg" alt="Tập Gym Cơ Bản" class="img-fluid">
                    </div>
                    
                    <p class="course-description">
                        Khóa học "Tập Gym Cơ Bản" được thiết kế dành cho người mới bắt đầu, giúp bạn làm quen với các bài tập gym cơ bản và xây dựng nền tảng thể lực vững chắc. Dưới sự hướng dẫn của các huấn luyện viên chuyên nghiệp, bạn sẽ nắm vững kỹ thuật tập luyện và cách sử dụng thiết bị gym một cách an toàn và hiệu quả.
                    </p>
                    
                    <h4 class="features-title">Đặc điểm nổi bật:</h4>
                    <ul class="features-list">
                        <li><i class="fas fa-check-circle"></i> Hướng dẫn chi tiết cho người mới bắt đầu.</li>
                        <li><i class="fas fa-check-circle"></i> Tập trung vào kỹ thuật và tư thế đúng.</li>
                        <li><i class="fas fa-check-circle"></i> Lộ trình tập luyện tăng dần theo thời gian.</li>
                    ...
                    <div class="course-info-card card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-info">
                                ...
                                <p><i class="fas fa-users"></i> <strong>Đối tượng:</strong> Người mới bắt đầu</p>
                                <p><i class="fas fa-user-tie"></i> <strong>Huấn luyện viên:</strong> Chuyên gia thể hình</p>
                                <p><i class="fas fa-clock"></i> <strong>Thời lượng:</strong> 3 buổi/tuần</p>
                            </div>
                            <form action="${pageContext.request.contextPath}/cart" method="post">
                                ...
                                <button type="submit" class="btn btn-warning btn-register btn-block">
                                    <i class="fas fa-dumbbell mr-2"></i> Đăng ký ngay
                                </button>
                            </form>
                        </div>
                    </div>
