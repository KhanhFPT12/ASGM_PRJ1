...
<head>
    ...
    <title>Chi tiết Khóa Học: Ta Don - 6Gym</title>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="course-header">
                        <h2 class="course-title">Ta Don</h2>
                    </div>

                    <div class="course-image">
                        <img src="${pageContext.request.contextPath}/images/tadon.jpg" alt="Ta Don" class="img-fluid">
                    </div>

                    <p class="course-description">
                        Khóa học "Ta Don" là chương trình tập luyện toàn diện, tập trung vào phát triển sức mạnh, sự linh hoạt và kỹ năng tự vệ.  Kết hợp các yếu tố của nhiều môn võ thuật, Ta Don mang đến một trải nghiệm tập luyện đầy thử thách và hiệu quả.
                    </p>

                    <h4 class="features-title">Đặc điểm nổi bật:</h4>
                    <ul class="features-list">
                        <li><i class="fas fa-check-circle"></i> Phát triển sức mạnh và sự dẻo dai.</li>
                        <li><i class="fas fa-check-circle"></i> Nâng cao kỹ năng tự vệ thực tế.</li>
                        <li><i class="fas fa-check-circle"></i> Tăng cường sự tự tin và kỷ luật.</li>
                        <li><i class="fas fa-check-circle"></i> Đốt cháy calo hiệu quả, cải thiện vóc dáng.</li>
                        <li><i class="fas fa-check-circle"></i> Huấn luyện bởi các chuyên gia giàu kinh nghiệm.</li>
                    </ul>
                </div>
                    ...
                    <div class="course-info-card card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-info">
                                ...
                                <p><i class="fas fa-users"></i> <strong>Đối tượng:</strong> Mọi đối tượng, không yêu cầu kinh nghiệm</p>
                                <p><i class="fas fa-user-tie"></i> <strong>Huấn luyện viên:</strong> Võ sư Trần Văn A</p>
                                <p><i class="fas fa-stopwatch"></i> <strong>Thời lượng:</strong> 60 phút/buổi, 3 buổi/tuần</p>
                            </div>
                            <form action="${pageContext.request.contextPath}/cart" method="post">
                                <input type="hidden" name="action" value="add">
                                <input type="hidden" name="courseId" value="7">
